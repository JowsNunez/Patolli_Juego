 ...
 * @author Kevin Rios
 */
public class GuiError extends javax.swing.JDialog {

    /**
     * Creates new form GuiError
     */
    public GuiError(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setToolTipText("Mensaje ");
        ...
        btnAceptar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true));
...
//        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GuiError dialog = new GuiError(new javax.swing.JFrame(), true);
